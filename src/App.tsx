    ...
    <div className="max-w-5xl mx-auto px-4 relative z-10 text-center">
      ...
      >
        ...
        <p className="text-base md:text-xl lg:text-[22px] text-white/70 mb-10 md:mb-14 max-w-4xl mx-auto leading-relaxed font-medium px-4">
          Agenti Proattivi, Master Prompt e Post-Produzione Avanzata.<br className="hidden md:block" />
          Un percorso di 40 ore per dominare il ciclo di produzione digitale tramite&nbsp;AI.
        </p>
        
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 mb-12 md:mb-16 max-w-4xl mx-auto">
          {( [
            { label: "Durata", val: "40 Ore" },
            { label: "Modalità", val: "FAD (Online)" },
            { label: "Tipologia", val: "Reskilling" },
...
const Program = () => {
  const modules: Module[] = [
    {
      title: "Strategia e Agenti Proattivi",
      content: [
        "Configurazione Agenti: Creazione di agenti specializzati in Google AI Studio",
        "Agentic Storytelling: Generazione autonoma di strategie e contenuti",
        "Analisi dei trend e automazione script per campagne ADV"
      ],
      image: "https://i.postimg.cc/4xd1hyXf/crea_una_immagine_202604141636.jpg",
      icon: Brain
    },
    {
      title: "Digital Shooting e Visual Design",
      content: [
        "Compositing avanzato con Nano Banana 2 per fusioni professionali",
        "Tecniche di coerenza visiva (Influencer AI)",
        "Advanced Lighting Prompting: Illuminazione fotorealistica ultra-reale"
      ],
      image: "https://i.postimg.cc/wM6XqG7L/crea_una_immagine_202604141612_(1).jpg",
      icon: Camera
    },
    {
      title: "Produzione Video e Spot",
      content: [
        "Creazione di 'Master prompt' per immagini e video virali",
        "Cinematografia con Veo 3.1: Controllo frame dinamico",
        "Video Automation: Da asset statici a Reel e TikTok (Image-to-Video)"
      ],
      image: "https://i.postimg.cc/NFz3qV4T/crea_una_immagine_202604141632.jpg",
      icon: Video
    },
    {
      title: "Sound Design e AI Avatar",
      content: [
        "Colonne sonore originali con Gemini Music",
        "Voice-Over e Cloning: Narrazioni realistiche con Qwen-TTS3",
        "Talking Avatar: Video 'Human-like' per messaggi marketing"
      ],
      image: "https://i.postimg.cc/qqq7xPqx/crea-una-immagine-202604141640.jpg",
      icon: Music
    },
    {
      title: "Editing con Da Vinci Resolve",
      content: [
        "Montaggio professionale del materiale generato",
        "Visual Enhancement: Color Correction e Grading cinematografico",
        "Mastering dell'audio: Ottimizzazione e finalizzazione professionale"
      ],
      image: "https://i.postimg.cc/sXQjBpND/crea-una-immagine-202604141615.jpg",
      icon: Film
    }
  ];
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 md:gap-12 mb-16 md:mb-24 border-b border-white/5 pb-12 md:pb-16">
          <div className="max-w-2xl">
            ...
            <p className="text-white/40 text-lg md:text-xl font-medium">
              Un percorso intensivo di 40 ore progettato per trasformarti in un professionista della produzione digitale con AI.
            </p>
          </div>
      ...
      <main>
        ...
        <section className="bg-[#1c2125] py-12 md:py-16 border-y border-white/5">
          <div className="max-w-7xl mx-auto px-4 grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-12">
            {( [
              { icon: Clock, title: "40 ORE", desc: "Formazione intensiva" },
              { icon: MapPin, title: "MODALITÀ FAD", desc: "Online in tempo reale" },
